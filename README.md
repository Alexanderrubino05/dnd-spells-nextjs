...
The project contains information about 50 different spells from D&D. Which can be sorted and searched through.
...
## API Key
1. See the api docs here at [https://open5e.com](https://open5e.com)
